...
\begin{align}
    a&=1\label{eq:315_bm}\\
    r&=z^{-1}\alpha^{2}\label{eq:316_bm}\\
    S_r&=\frac{a}{1-r}\label{eq:317_bm}
\end{align}
Using \eqref{eq:315_bm},\eqref{eq:316_bm} and \eqref{eq:317_bm} in \eqref{eq:314_bm}:
\begin{align}
\frac{1}{1-0.5z^{-1}}&=\frac{1}{1-z^{-1}\alpha^{2}}\label{eq:318_bm}\\
1-0.5z^{-1}&=1-z^{-1}\alpha^{2}\label{eq:319_bm}\\
\alpha^{2}&=0.5\label{eq:320_bm}\\
\alpha&=\sqrt{0.5}\label{eq:321_bm}\\
\alpha&=\frac{1}{\sqrt{2}}\label{eq:322_bm}
\end{align}
